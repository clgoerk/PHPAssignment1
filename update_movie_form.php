...
<html>
  ...
  <body>
    ...
    <main>
      ...
      <form action="update_movie.php" method="post" id="update_movie_form"
        ...
        <div id="data">
          ...
          <input type="text" name="title"
            value="<?php echo $movie['title']; ?>" /><br />

          <label>Year:</label>
          <input type="date" name="year"
            value="<?php echo $movie['year']; ?>" /><br />

          <label>Genre:</label>
          <input type="text" name="genre"
            value="<?php echo $movie['genre']; ?>" /><br />

          <label>Director:</label>
          <input type="text" name="director"
            value="<?php echo $movie['director']; ?>" /><br />

          <label>Duration:</label>
          <input type="text" name="duration"
            value="<?php echo $movie['duration']; ?>" /><br />

          <label>Language:</label>
          <input type="text" name="language"
            value="<?php echo $movie['language']; ?>" /><br />

          <label>Rating:</label>
          <input type="text" name="rating"
            value="<?php echo $movie['rating']; ?>" /><br />
